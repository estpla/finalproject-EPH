...
jest.mock('../../../src/middlewares/authMiddleware', () => {
  ...
  mockCheckRole.mockImplementation((roles) => (req, res, next) => {
...
describe('Workout Routes', () => {
  ...
  describe('GET /', () => {
    it('debería llamar a getAllWorkouts', async () => {
      workoutController.getAllWorkouts.mockImplementation((req, res) => res.json([]));
  ...
  describe('GET /:id', () => {
    it('debería llamar a getWorkoutById con el ID proporcionado', async () => {
      ...
      workoutController.getWorkoutById.mockImplementation((req, res) => res.json(mockWorkout));
  ...
  describe('POST /', () => {
    it('debería verificar el token y el rol antes de crear un workout', async () => {
      workoutController.createWorkout.mockImplementation((req, res) => res.status(201).json({}));
  ...
  describe('PUT /:id', () => {
    it('debería verificar el token y el rol antes de actualizar un workout', async () => {
      workoutController.updateWorkout.mockImplementation((req, res) => res.json({}));
  ...
  describe('DELETE /:id', () => {
    it('debería verificar el token y el rol antes de eliminar un workout', async () => {
      workoutController.deleteWorkout.mockImplementation((req, res) => res.status(204).send());
